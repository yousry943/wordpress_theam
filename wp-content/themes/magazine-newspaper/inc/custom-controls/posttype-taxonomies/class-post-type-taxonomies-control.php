...
class Magazine_Newspaper_Dropdown_Posttype_Taxonomies extends WP_Customize_Control {
		...
		<label>
	      <span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
	         <select <?php echo $this->link(); ?>>
	            <?php
	              printf('<option value="%s" %s>%s</option>', '', selected($this->value(), '', false), esc_html__( 'Select', 'magazine-newspaper') );
	             ?>
