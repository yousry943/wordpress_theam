    ...
    class Magazine_Newspaper_Control_Repeater extends WP_Customize_Control {
    	...
    	public function __construct( $manager, $id, $args = array() ) {
    		...
    		$this->row_label = array(
    			'type' => 'text',
    			'value' => esc_html__( 'row', 'magazine-newspaper' ),
    			'field' => false,
    		);
    		...
    		if ( empty( $this->button_label ) ) {
    			$this->button_label = sprintf( esc_html__( 'Add new %s', 'magazine-newspaper' ), $this->row_label['value'] );
    		}
    	...
    	protected function render_content() {
    		...
    		<?php if ( isset( $this->choices['limit'] ) ) : ?>
    			<p class="limit"><?php printf( esc_html__( 'Limit: %s rows', 'magazine-newspaper' ), esc_html( $this->choices['limit'] ) ); ?></p>
    		<?php endif; ?>
    		...
    		<script type="text/html" class="customize-control-repeater-content">
    			...
    			<li class="repeater-row minimized" data-row="{{{ index }}}">
    				...
    				<div class="repeater-row-content">
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="magazine-newspaper-image-attachment" data-placeholder="<?php echo esc_attr( 'No Image Selected', 'magazine-newspaper' ); ?>" >
    									<# if ( field.default ) { #>
    										<# var defaultImageURL = ( field.default.url ) ? field.default.url : field.default; #>
    										<img src="{{{ defaultImageURL }}}">
    									<# } else { #>
    										<?php esc_html_e( 'No Image Selected', 'magazine-newspaper' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_html_e( 'Remove', 'magazine-newspaper' ); ?></button>
    									<button type="button" class="button upload-button" data-label=" <?php echo esc_attr( 'Add Image', 'magazine-newspaper' ); ?>" data-alt-label="<?php echo esc_attr( 'Change Image', 'magazine-newspaper' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_html_e( 'Change Image', 'magazine-newspaper' ); ?>
    										<# } else { #>
    											<?php esc_html_e( 'Add Image', 'magazine-newspaper' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="magazine-newspaper-file-attachment" data-placeholder="<?php echo esc_attr( 'No File Selected', 'magazine-newspaper' ); ?>" >
    									<# if ( field.default ) { #>
    									...
    									<# } else { #>
    										<?php esc_html_e( 'No File Selected', 'magazine-newspaper' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"></button>
    									<button type="button" class="button upload-button" data-label="<?php echo esc_attr( 'Add File', 'magazine-newspaper' ); ?>" data-alt-label="<?php echo esc_attr( 'Change File', 'magazine-newspaper' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_html_e( 'Change File', 'magazine-newspaper' ); ?>
    										<# } else { #>
    											<?php esc_html_e( 'Add File', 'magazine-newspaper' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    										<input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
    					...
    					<# }); #>
    					<button type="button" class="button-link repeater-row-remove"><?php esc_html_e( 'Remove', 'magazine-newspaper' ); ?></button>
    				</div>
    			</li>
    		</script>
    		<?php
