...
wp.customize.controlConstructor.repeater = wp.customize.Control.extend({
	ready: function() {
		...
		// The current value set in Control Class (set in Avid_Magazine_Customize_Repeater_Control::to_json() function)
	...
	addRow: function( data ) {
		...
		var control       = this,
		    template      = control.repeaterTemplate(), // The template for the new row (defined on Avid_Magazine_Customize_Repeater_Control::render_content() ).
